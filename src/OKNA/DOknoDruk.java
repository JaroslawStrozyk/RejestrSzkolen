...
public class DOknoDruk extends javax.swing.JDialog {
    ...
    public DOknoDruk(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton2.setText("Strona nr 1  (Wizytówka)");
        ...
        jButton3.setText("Strona nr 2 (Opis szkolenia)");
    ...
    private void WyborWzoru(String data, String kod) throws FileNotFoundException{
        ...
        Wzor1 = sciezka + kod +"a.jrxml";
        Wzor2 = sciezka + kod +"b.jrxml";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(DOknoDruk.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DOknoDruk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DOknoDruk dialog = new DOknoDruk(new javax.swing.JFrame(), true);
